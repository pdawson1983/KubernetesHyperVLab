...
| Task                                               | Priority | Notes                                                                                                                                                                                                                                                                   |
| -------------------------------------------------- | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Token consumption tracking                        | High     | Capture input+output token counts per agent run; store in agent_runs Postgres columns (tokens_input, tokens_output); show per-agent and totals on dashboard and task detail. Requires Claude Code to emit token usage — check if --print mode outputs usage stats, or parse output log. |
